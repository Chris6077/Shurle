...
$(document).ready(function(){
  ...
  $('.api').on('click', function(){
    if(api){
      ...
      $('.container')[0].innerHTML = "<h2>Example inputs:</h2> <p>https://shurle.glitch.me/new/google.com</p> <p>https://shurle.glitch.me/new/http://www.google.com</p> <p>https://shurle.glitch.me/new/http://google.com</p> <p>https://shurle.glitch.me/new/www.google.com</p> <h2>These inputs will return this:</h2> <p>{ \"shortUrl\": \"shurle.glitch.me/1\" }</p> <h2> This service differs HTTPS and HTTP and automatically adds HTTP if no protocol is given. Works with mailto etc. too.</h2>";
